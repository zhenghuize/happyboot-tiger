import{_ as ee,h as F}from"./index.4938ee75.js";import{z as N,p as l,h as B,A as y,B as we,J as ye,C as Q,U as at,i as Ce,T as lt,E as U,O as st,D as V,M as ne,N as Le,V as ct,j as dt,o as z,q as M,L as w,a1 as Ve,a2 as ke,c as E,l as d,a3 as ut,k as b,w as I,W as Ke,a4 as De,m as de,t as Ue,a5 as mt,X as ze,Y as $e,n as J,r as ht,a6 as ft}from"./vendor.f9e4f91a.js";import{c as k,K as pt,a as g,d as x,b as $,G as vt,p as gt,f as q,u as L,g as D,h as Y,L as bt,l as ue,C as Z,j as qe,t as We,n as W,N as xt}from"./Space.cb2e4e91.js";import{f as je,g as yt,r as G,c as _t,N as Ge}from"./fade-in-scale-up.cssr.5d9a3f22.js";import{N as Ie}from"./FadeInExpandTransition.0a3e7cfe.js";import{N as Ne,o as wt}from"./Dropdown.b8c65c88.js";import{N as Ct}from"./Tooltip.4b3a96e0.js";import{k as Se,u as Te,b as kt,c as zt,N as j}from"./Icon.54169ce7.js";import{k as ge,u as Ye}from"./Popover.3af6d985.js";import{f as Xe}from"./fade-in-height-expand.cssr.4d4702e5.js";import{p as $t,l as It,a as Nt,N as se}from"./Layout.851e249c.js";import{b as St,d as Rt,m as Pt,c as Mt,t as At,e as be,a as oe,f as Ot}from"./config.9bb2ea46.js";import{C as Re}from"./CubeOutline.d62a720f.js";import{d as Bt,e as Lt,c as jt,b as Tt,a as Et,N as le}from"./Button.ede6cac8.js";import{m as Je,a as Ft,u as Ht}from"./use-message.bbaf85b4.js";import{N as Vt}from"./Carousel.89ab92f6.js";import{N as Kt}from"./Switch.ca55c3ce.js";import{N as _e}from"./Avatar.742ed055.js";import{C as Dt}from"./CloseSharp.e65bbbe3.js";import{N as Ut}from"./Tag.4a645221.js";import{N as qt}from"./GradientText.a57cf72f.js";import{N as ce}from"./LayoutHeader.43d823ec.js";import{z as Wt,d as Gt,N as Yt}from"./ConfigProvider.5420ed68.js";import{I as Xt,S as Jt,W as Zt,E as Qt}from"./Warning.97fcb637.js";import{N as eo}from"./LayoutSider.4999cf30.js";import{N as to}from"./LayoutContent.06a6eaaa.js";import"./light.bd64e00f.js";import"./index.c0ca19c9.js";import"./ChevronRight.fb8aca55.js";import"./light.5a0159f0.js";import"./light.076f84b5.js";import"./light.3474f3a3.js";import"./light.adf64e59.js";import"./light.8330dae1.js";import"./ScrollBar.244c3ed8.js";import"./_common.81364e7f.js";import"./light.9d147ac5.js";import"./light.6c7615e5.js";import"./light.46b13c5e.js";import"./light.a05828c9.js";import"./light.f3513c5b.js";import"./_common.c609fc90.js";import"./light.026b2e01.js";import"./light.d4f7dd20.js";import"./light.53c8705c.js";import"./use-houdini.7dfba0ae.js";import"./index.7d569ca2.js";const oo=typeof window!="undefined";var no=N({name:"ChevronDownFilled",render(){return l("svg",{viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},l("path",{d:"M3.20041 5.73966C3.48226 5.43613 3.95681 5.41856 4.26034 5.70041L8 9.22652L11.7397 5.70041C12.0432 5.41856 12.5177 5.43613 12.7996 5.73966C13.0815 6.0432 13.0639 6.51775 12.7603 6.7996L8.51034 10.7996C8.22258 11.0668 7.77743 11.0668 7.48967 10.7996L3.23966 6.7996C2.93613 6.51775 2.91856 6.0432 3.20041 5.73966Z",fill:"currentColor"}))}}),Ee=N({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const t=B(null),o=B(e.value),i=B(e.value),n=B("up"),r=B(!1),c=y(()=>r.value?`${e.clsPrefix}-base-slot-machine-current-number--${n.value}-scroll`:null),u=y(()=>r.value?`${e.clsPrefix}-base-slot-machine-old-number--${n.value}-scroll`:null);we(Q(e,"value"),(a,f)=>{o.value=f,i.value=a,ye(s)});function s(){const a=e.newOriginalNumber,f=e.oldOriginalNumber;f===void 0||a===void 0||(a>f?m("up"):f>a&&m("down"))}function m(a){n.value=a,r.value=!1,ye(()=>{var f;(f=t.value)===null||f===void 0||f.offsetWidth,r.value=!0})}return()=>{const{clsPrefix:a}=e;return l("span",{ref:t,class:`${a}-base-slot-machine-number`},o.value!==null?l("span",{class:[`${a}-base-slot-machine-old-number ${a}-base-slot-machine-old-number--top`,u.value]},o.value):null,l("span",{class:[`${a}-base-slot-machine-current-number`,c.value]},l("span",{ref:"numberWrapper",class:[`${a}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${a}-base-slot-machine-current-number__inner--not-number`]},i.value)),o.value!==null?l("span",{class:[`${a}-base-slot-machine-old-number ${a}-base-slot-machine-old-number--bottom`,u.value]},o.value):null)}}});const{cubicBezierEaseOut:X}=pt;function ro({duration:e=".2s"}={}){return[k("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${X},
 max-width ${e} ${X},
 transform ${e} ${X}
